...
/**
 * PaymentProviderAttributes Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentProviderAttributes implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentProviderAttributes';
    ...
    /**
     * Sets name
     * @param string $name Payment-provider`s name
     * @return $this
     */
    ...
    /**
     * Sets alias
     * @param string $alias Payment-provider`s alias
     * @return $this
     */
