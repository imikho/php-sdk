 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentMethodAttributes implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentMethodAttributes';
    ...
    /**
     * Sets name
     * @param string $name Payment-method`s name
     * @return $this
     */
    ...
    /**
     * Sets alias
     * @param string $alias Payment-method`s alias
     * @return $this
     */
    ...
    /**
     * Sets processor_name
     * @param string $processor_name Payment-method`s processor
     * @return $this
     */
