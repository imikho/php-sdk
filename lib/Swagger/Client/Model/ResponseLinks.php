...
class ResponseLinks implements ArrayAccess
{
    ...
    /**
     * Sets first
     * @param string $first first page of query
     * @return $this
     */
    ...
    /**
     * Sets prev
     * @param string $prev previous page in query
     * @return $this
     */
    ...
    /**
     * Sets next
     * @param string $next next page in query
     * @return $this
     */
    ...
    /**
     * Sets last
     * @param string $last last page of query
     * @return $this
     */
