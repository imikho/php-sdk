...
/**
 * ExchangerAttributesOrganization Class Doc Comment
 *
 * @category    Class */
/**
 * @package     OFT
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ExchangerAttributesOrganization implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExchangerAttributesOrganization';
    ...
    /**
     * Sets name
     * @param string $name Exchanger`s name
     * @return $this
     */
