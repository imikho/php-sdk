...
/**
 * PaymentProcessorsApi Class Doc Comment
 *
 * @category Class
 * @package  OFT
 * @author   Swagger Codegen team
...
class PaymentProcessorsApi
{
    ...
    /**
     * Operation paymentProcessorsGet
     *
     ...
     * @return \Swagger\Client\Model\PaymentProcessorsResponse
     */
    public function paymentProcessorsGet($page_number = null, $page_size = null, $filter_name = null)
    {
        list($response) = $this->paymentProcessorsGetWithHttpInfo($page_number, $page_size, $filter_name);
        return $response;
    }

    /**
     * Operation paymentProcessorsGetWithHttpInfo
     *
     * List of payment processors
     *
     * @param int $page_number Current page number. (optional)
     ...
     * @param string $filter_name Filtering by name. (optional)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\PaymentProcessorsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentProcessorsGetWithHttpInfo($page_number = null, $page_size = null, $filter_name = null)
    {
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PaymentProcessorsResponse',
                '/payment-processors'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PaymentProcessorsResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PaymentProcessorsResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation paymentProcessorsIdGet
     *
     * Payment processor by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \OFT\ApiException on non-2xx response
     * @return \Swagger\Client\Model\PaymentProcessorResponse
     */
    public function paymentProcessorsIdGet($id)
    {
        list($response) = $this->paymentProcessorsIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation paymentProcessorsIdGetWithHttpInfo
     *
     * Payment processor by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\PaymentProcessorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentProcessorsIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling paymentProcessorsIdGet');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PaymentProcessorResponse',
                '/payment-processors/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PaymentProcessorResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PaymentProcessorResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
