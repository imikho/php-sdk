...
/**
 * ExchangersApi Class Doc Comment
 *
 * @category Class
 * @package  OFT
 * @author   Swagger Codegen team
...
class ExchangersApi
{
     ...
     * @param string[] $sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | status | -status | | wmid | -wmid | | rate_type | -rate_type | | rates_export_standard | &lt;nobr&gt;-rates_export_standard&lt;/nobr&gt; | (optional)
     * @throws \OFT\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ExchangersResponse
     */
    public function exchangersGet($page_number = null, $page_size = null, $filter_name = null, $filter_status = null, $sort = null)
    {
        list($response) = $this->exchangersGetWithHttpInfo($page_number, $page_size, $filter_name, $filter_status, $sort);
        return $response;
    }

    /**
     * Operation exchangersGetWithHttpInfo
     *
     * List of exchangers
     *
     * @param int $page_number Current page number. (optional)
     ...
     * @param string[] $sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | status | -status | | wmid | -wmid | | rate_type | -rate_type | | rates_export_standard | &lt;nobr&gt;-rates_export_standard&lt;/nobr&gt; | (optional)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ExchangersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function exchangersGetWithHttpInfo($page_number = null, $page_size = null, $filter_name = null, $filter_status = null, $sort = null)
    {
        // parse inputs
        $resourcePath = "/exchangers";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ExchangersResponse',
                '/exchangers'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ExchangersResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ExchangersResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation exchangersIdGet
     *
     * Exchanger by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \OFT\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ExchangerResponse
     */
    public function exchangersIdGet($id)
    {
        list($response) = $this->exchangersIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation exchangersIdGetWithHttpInfo
     *
     * Exchanger by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\ExchangerResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function exchangersIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling exchangersIdGet');
        }
        // parse inputs
        $resourcePath = "/exchangers/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ExchangerResponse',
                '/exchangers/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ExchangerResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ExchangerResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
