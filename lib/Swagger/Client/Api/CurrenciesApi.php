...
class CurrenciesApi
{
     ...
     * @param string $filter_code_iso_alpha3 Filtering by ISO code. (optional)
     * @param int $filter_code_iso_numeric3 Filtering by ISO number. (optional)
     * @param string $filter_code_estandards_alpha Filtering by estandards code. (optional)
     * @param string[] $filter_currency_type Filtration by currency type. (optional)
     * @param string[] $filter_category Filtration by category. (optional)
     * @param string[] $sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | type | -type | | category | -category | | code | -code | | code_iso_alpha3 | -code_iso_alpha3 | | code_iso_numeric3 | -code_iso_numeric3 | | code_estandards_alpha | -code_estandards_alpha | (optional)
     * @throws \OFT\ApiException on non-2xx response
     * @return \Swagger\Client\Model\CurrenciesResponse
     */
    public function currenciesGet($page_number = null, $page_size = null, $filter_code_iso_alpha3 = null, $filter_code_iso_numeric3 = null, $filter_code_estandards_alpha = null, $filter_currency_type = null, $filter_category = null, $sort = null)
    {
        list($response) = $this->currenciesGetWithHttpInfo($page_number, $page_size, $filter_code_iso_alpha3, $filter_code_iso_numeric3, $filter_code_estandards_alpha, $filter_currency_type, $filter_category, $sort);
        return $response;
    }
     ...
     * @param string[] $sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | type | -type | | category | -category | | code | -code | | code_iso_alpha3 | -code_iso_alpha3 | | code_iso_numeric3 | -code_iso_numeric3 | | code_estandards_alpha | -code_estandards_alpha | (optional)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\CurrenciesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function currenciesGetWithHttpInfo($page_number = null, $page_size = null, $filter_code_iso_alpha3 = null, $filter_code_iso_numeric3 = null, $filter_code_estandards_alpha = null, $filter_currency_type = null, $filter_category = null, $sort = null)
    {
        // parse inputs
        ...
        // query params
        if ($filter_code_iso_alpha3 !== null) {
            $queryParams['filter[code_iso_alpha3]'] = $this->apiClient->getSerializer()->toQueryValue($filter_code_iso_alpha3);
        }
        // query params
        if ($filter_code_iso_numeric3 !== null) {
            $queryParams['filter[code_iso_numeric3]'] = $this->apiClient->getSerializer()->toQueryValue($filter_code_iso_numeric3);
        }
        // query params
        if ($filter_code_estandards_alpha !== null) {
            $queryParams['filter[code_estandards_alpha]'] = $this->apiClient->getSerializer()->toQueryValue($filter_code_estandards_alpha);
        }
        // query params
        if (is_array($filter_currency_type)) {
            $filter_currency_type = $this->apiClient->getSerializer()->serializeCollection($filter_currency_type, 'csv', true);
        }
        if ($filter_currency_type !== null) {
            $queryParams['filter[currency_type]'] = $this->apiClient->getSerializer()->toQueryValue($filter_currency_type);
        }
        // query params
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\CurrenciesResponse',
                '/currencies'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\CurrenciesResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\CurrenciesResponse', $e->getResponseHeaders());
     ...
     * @throws \OFT\ApiException on non-2xx response
     * @return \Swagger\Client\Model\CurrencyResponse
     */
    public function currenciesIdGet($id)
    {
        list($response) = $this->currenciesIdGetWithHttpInfo($id);
        return $response;
    }
     ...
     * @param string $id Unique ID. (required)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\CurrencyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function currenciesIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling currenciesIdGet');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\CurrencyResponse',
                '/currencies/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\CurrencyResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\CurrencyResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
