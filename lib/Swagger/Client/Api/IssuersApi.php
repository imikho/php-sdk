...
class IssuersApi
{
     ...
     * @return \Swagger\Client\Model\IssuersResponse
     */
    public function currencyIssuersGet($page_number = null, $page_size = null)
    {
        list($response) = $this->currencyIssuersGetWithHttpInfo($page_number, $page_size);
        return $response;
    }

    /**
     * Operation currencyIssuersGetWithHttpInfo
     *
     * List of currency issuers
     *
     * @param int $page_number Current page number. (optional)
     * @param int $page_size Page size.&lt;br&gt;*Default value: 100* (optional)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\IssuersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function currencyIssuersGetWithHttpInfo($page_number = null, $page_size = null)
    {
        // parse inputs
        $resourcePath = "/currency-issuers";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\IssuersResponse',
                '/currency-issuers'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\IssuersResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\IssuersResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation currencyIssuersIdGet
     *
     * Issuer by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \OFT\ApiException on non-2xx response
     * @return \Swagger\Client\Model\IssuerResponse
     */
    public function currencyIssuersIdGet($id)
    {
        list($response) = $this->currencyIssuersIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation currencyIssuersIdGetWithHttpInfo
     *
     * Issuer by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \OFT\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\IssuerResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function currencyIssuersIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling currencyIssuersIdGet');
        }
        // parse inputs
        $resourcePath = "/currency-issuers/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\IssuerResponse',
                '/currency-issuers/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\IssuerResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\IssuerResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
