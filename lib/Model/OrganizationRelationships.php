...
/**
 * OrganizationRelationships Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OrganizationRelationships implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrganizationRelationships';
    ...
    protected static $swaggerTypes = [
        'source_register_org' => '\Swagger\Client\Model\OrganizationSource',
        'hq_in_country' => '\Swagger\Client\Model\OrganizationHq',
        'active_in_countries' => '\Swagger\Client\Model\OrganizationActive'
    ];
    ...
    protected static $setters = [
        'source_register_org' => 'setSourceRegisterOrg',
        'hq_in_country' => 'setHqInCountry',
        'active_in_countries' => 'setActiveInCountries'
    ];
    ...
    protected static $getters = [
        'source_register_org' => 'getSourceRegisterOrg',
        'hq_in_country' => 'getHqInCountry',
        'active_in_countries' => 'getActiveInCountries'
    ];
    ...
    {
        $this->container['source_register_org'] = isset($data['source_register_org']) ? $data['source_register_org'] : null;
        $this->container['hq_in_country'] = isset($data['hq_in_country']) ? $data['hq_in_country'] : null;
        $this->container['active_in_countries'] = isset($data['active_in_countries']) ? $data['active_in_countries'] : null;
    }
    ...
    /**
     * Gets source_register_org
     * @return \Swagger\Client\Model\OrganizationSource
     */
    public function getSourceRegisterOrg()
    {
        return $this->container['source_register_org'];
    }

    /**
     * Sets source_register_org
     * @param \Swagger\Client\Model\OrganizationSource $source_register_org
     * @return $this
     */
    public function setSourceRegisterOrg($source_register_org)
    {
        $this->container['source_register_org'] = $source_register_org;
    ...
    /**
     * Gets hq_in_country
     * @return \Swagger\Client\Model\OrganizationHq
     */
    public function getHqInCountry()
    {
        return $this->container['hq_in_country'];
    }

    /**
     * Sets hq_in_country
     * @param \Swagger\Client\Model\OrganizationHq $hq_in_country
     * @return $this
     */
    public function setHqInCountry($hq_in_country)
    {
        $this->container['hq_in_country'] = $hq_in_country;

        return $this;
    }

    /**
     * Gets active_in_countries
     * @return \Swagger\Client\Model\OrganizationActive
     */
    public function getActiveInCountries()
    {
        return $this->container['active_in_countries'];
    }

    /**
     * Sets active_in_countries
     * @param \Swagger\Client\Model\OrganizationActive $active_in_countries
     * @return $this
     */
    public function setActiveInCountries($active_in_countries)
    {
        $this->container['active_in_countries'] = $active_in_countries;
