...
/**
 * PaymentProcessorAttributes Class Doc Comment
 *
 * @category    Class */
 // @description Array of Payment-processor attributes
/**
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentProcessorAttributes implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentProcessorAttributes';
    ...
    /**
     * Sets name
     * @param string $name Payment-processor`s name
     * @return $this
     */
