...
/**
 * BankAttributes Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BankAttributes implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankAttributes';
    ...
    /**
     * Sets city
     * @param string $city Bank`s location
     * @return $this
     */
    ...
    /**
     * Sets alias
     * @param string $alias Bank`s alias
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param string $status Status [active, liquidated, problem, deleted]
     * @return $this
     */
