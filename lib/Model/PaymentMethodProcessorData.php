...
/**
 * PaymentMethodProcessorData Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentMethodProcessorData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentMethodProcessorData';
    ...
    /**
     * Sets type
     * @param string $type Processor`s type.
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string $id Processor`s id.
     * @return $this
     */
