...
/**
 * OrganizationSocial Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OrganizationSocial implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrganizationSocial';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['vkontakte'] = isset($data['vkontakte']) ? $data['vkontakte'] : null;
    }
    ...
    {
        return $this->container['vkontakte'];
    }
    ...
    {
        $this->container['vkontakte'] = $vkontakte;
