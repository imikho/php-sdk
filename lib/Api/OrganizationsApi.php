...
class OrganizationsApi
{
     ...
     * @param string $filter_industries Filtering by industries. (optional)
     * @param string[] $sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | alias | -alias | | status | -status | | description | -description | (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\OrganizationsResponse
     */
    public function organizationsGet($page_number = null, $page_size = null, $filter_name = null, $filter_alias = null, $filter_status = null, $filter_industries = null, $sort = null)
    {
        list($response) = $this->organizationsGetWithHttpInfo($page_number, $page_size, $filter_name, $filter_alias, $filter_status, $filter_industries, $sort);
        return $response;
    }
     ...
     * @param string[] $sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | alias | -alias | | status | -status | | description | -description | (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\OrganizationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function organizationsGetWithHttpInfo($page_number = null, $page_size = null, $filter_name = null, $filter_alias = null, $filter_status = null, $filter_industries = null, $sort = null)
    {
        // parse inputs
        ...
        // query params
        if ($filter_industries !== null) {
            $queryParams['filter[industries]'] = $this->apiClient->getSerializer()->toQueryValue($filter_industries);
        }
        // query params
        if (is_array($sort)) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\OrganizationsResponse',
                '/organizations'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\OrganizationsResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\OrganizationsResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation organizationsIdGet
     *
     * Organization by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\OrganizationResponse
     */
    public function organizationsIdGet($id)
    {
        list($response) = $this->organizationsIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation organizationsIdGetWithHttpInfo
     *
     * Organization by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\OrganizationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function organizationsIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling organizationsIdGet');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\OrganizationResponse',
                '/organizations/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\OrganizationResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\OrganizationResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
