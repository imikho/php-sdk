...
class IndustriesApi
{
    ...
    /**
     * Operation organizationIndustriesGet
     *
     ...
     * @return \Swagger\Client\Model\IndustriesResponse
     */
    public function organizationIndustriesGet($page_number = null, $page_size = null)
    {
        list($response) = $this->organizationIndustriesGetWithHttpInfo($page_number, $page_size);
        return $response;
    }

    /**
     * Operation organizationIndustriesGetWithHttpInfo
     *
     * List of organization industries
     *
     * @param int $page_number Current page number. (optional)
     * @param int $page_size Page size.&lt;br&gt;*Default value: 100* (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\IndustriesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function organizationIndustriesGetWithHttpInfo($page_number = null, $page_size = null)
    {
        // parse inputs
        $resourcePath = "/organization-industries";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\IndustriesResponse',
                '/organization-industries'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\IndustriesResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\IndustriesResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation organizationIndustriesIdGet
     *
     * Industry by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\IndustryResponse
     */
    public function organizationIndustriesIdGet($id)
    {
        list($response) = $this->organizationIndustriesIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation organizationIndustriesIdGetWithHttpInfo
     *
     * Industry by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\IndustryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function organizationIndustriesIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling organizationIndustriesIdGet');
        }
        // parse inputs
        $resourcePath = "/organization-industries/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\IndustryResponse',
                '/organization-industries/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\IndustryResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\IndustryResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
