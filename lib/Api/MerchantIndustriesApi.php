...
/**
 * MerchantIndustriesApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class MerchantIndustriesApi
{
    ...
    /**
     * Operation merchantIndustriesGet
     *
     ...
     * @return \Swagger\Client\Model\MerchantIndustriesResponse
     */
    public function merchantIndustriesGet($page_number = null, $page_size = null, $filter_name = null)
    {
        list($response) = $this->merchantIndustriesGetWithHttpInfo($page_number, $page_size, $filter_name);
        return $response;
    }

    /**
     * Operation merchantIndustriesGetWithHttpInfo
     *
     * List of merchant industries
     *
     * @param int $page_number Current page number. (optional)
     ...
     * @param string $filter_name Filtering by name. (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\MerchantIndustriesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function merchantIndustriesGetWithHttpInfo($page_number = null, $page_size = null, $filter_name = null)
    {
        // parse inputs
        $resourcePath = "/merchant-industries";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\MerchantIndustriesResponse',
                '/merchant-industries'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\MerchantIndustriesResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\MerchantIndustriesResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation merchantIndustriesIdGet
     *
     * Merchant industry by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\MerchantIndustryResponse
     */
    public function merchantIndustriesIdGet($id)
    {
        list($response) = $this->merchantIndustriesIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation merchantIndustriesIdGetWithHttpInfo
     *
     * Merchant industry by ID
     *
     * @param string $id Unique ID. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\MerchantIndustryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function merchantIndustriesIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling merchantIndustriesIdGet');
        }
        // parse inputs
        $resourcePath = "/merchant-industries/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\MerchantIndustryResponse',
                '/merchant-industries/{id}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\MerchantIndustryResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\MerchantIndustryResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
